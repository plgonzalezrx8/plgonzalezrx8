...
- **[bluewebcrawler](https://github.com/plgonzalezrx8/bluewebcrawler)** - A Node + TypeScript crawler that maps a site and exports AI-ready markdown.
- **[InfiniMind](https://github.com/plgonzalezrx8/InfiniMind)** - A Docker-first memory sidecar for OpenClaw with a dedicated memory service and bridge plugin.
- **[OpenClaw-Skills](https://github.com/plgonzalezrx8/OpenClaw-Skills)** - Custom skills that extend OpenClaw with specialized commands and integrations.
...
- Offensive security workflows that are practical, repeatable, and operator-friendly
- AI agent tooling that is observable, composable, and useful outside of demos
- Memory and context systems that make agents more reliable over time
- Tooling for small teams that need leverage, not extra complexity

## Ecosystems I'm Exploring

These are projects I am actively exploring, testing, or contributing around:

- **[mission-control](https://github.com/plgonzalezrx8/mission-control)** - Open source dashboard for AI agent orchestration
- **[clawtelemetry](https://github.com/plgonzalezrx8/clawtelemetry)** - Real-time observability dashboard for OpenClaw AI agents
- **[openclaw](https://github.com/plgonzalezrx8/openclaw)** - Personal AI assistant infrastructure across platforms
...
> Security without execution is just theater. I prefer tools that earn their keep in the first five minutes.
